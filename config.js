module.exports = {
	...
	adminId: "615687360138575893" || "", //- Replace UserId with the Discord ID of the admin of the bot
	...
	Issues: "https://github.com/Knight0fNever/Discord-MusicBot/issues", //- Bug Report Link
	...
	cookieSecret: "Knight0fNever is epic", //- Cookie Secret
	website: "http://localhost:4200", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "main_node", //- Used for indentifier in stats commands.
			...
			password: "lxhU%8%7I&%ttlHB5BN^EaLC9Z%!9X0", //- The password of the lavalink server.
